...
//
// This algorithm implements a cyclic buffer to synchronize two
// asynchronous producer and consumer processes without the
...
#define BUFPEEK(BUF)  ((BUF.rdr) & BUFMSK)
#define BUFRINC(BUF)  ++BUF.rdr
